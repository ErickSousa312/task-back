...
import { TOKEN, USER_ID, EMAIL, APP_NAME } from "env";
import { escreverBancoDeDados,lerBancoDeDados } from "utils/db";
...
async function postProduct (){
  ...
  try {
    ...
    const database:any = lerBancoDeDados()
...
async function  deleteProductsNuvemShop(id:number){
